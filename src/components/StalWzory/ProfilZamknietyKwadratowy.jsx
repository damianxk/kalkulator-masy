...
const ProfilZamknietyKwadratowy = () => {
  ...
  const calculateWeight = () => {
    const outerVolume = Math.pow(width / 10000, 2);
    const innerVolume = Math.pow((width - 2 * thickness) / 10000, 2);
    const volume = outerVolume - innerVolume;
    const weightPerMeter = volume * 7.85; // Assuming the density of steel is 7.85 g/cm^3
